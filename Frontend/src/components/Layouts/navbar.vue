<template>
  <div class="sticky top-0 z-40">
          <div class="w-full h-20 px-6 bg-SecundaryGold border-b flex items-center justify-between">
          ...
          <!-- dropdown menu -->
          <div class="absolute bg-gray-100 border border-t-0 shadow-xl text-gray-700 rounded-b-lg w-48 top-full right-0 mr-6" :class="dropDownOpen ? '' : 'hidden'">
              <button @click="handleLogout" class="block px-4 py-2 hover:bg-gray-200">Logout</button>
          </div>
          <!-- dropdown menu end -->
