<template>
  ...
  <div
    class="w-1/2 md:w-1/3 lg:w-64 fixed md:top-0 md:left-0 h-screen lg:block bg-primaryBlue border-r z-30"
    :class="sideBarOpen ? '' : 'hidden'"
    id="main-nav"
  >
    <div class="w-full h-20 border-b border-l-blue-900 flex px-4 items-center mb-8">
    ...
    <div class="mb-4 px-4">
      ...
      <router-link to="/ensenanza">
        ...
        >
          <i class="pi pi-home text-2xl fill-current mr-2"></i>
      ...
      >
        <i class="pi pi-home text-2xl fill-current mr-2"></i>
        <span class="text-white">Enquiries</span>
      </div>
      <div
        class="w-full flex items-center text-SecundaryGold h-10 pl-4 hover:bg-SecundaryGold rounded-lg cursor-pointer hover:text-white"
      >
    ...
    <div class="mb-4 px-4">
      ...
      <div
        class="w-full flex items-center text-SecundaryGold h-10 pl-4 hover:bg-SecundaryGold rounded-lg cursor-pointer"
      >
